...
function Outline(canvas, options, viewport) {
    ...
    function drawRect(rect, strokeWidth, strokeStyle, fillStyle, invert) {
        ...
        if (fillStyle) {
            ...
            if (invert) {
                ...
                context.rect(currentContentRect.left, rect.top, currentContentRect.width, rect.height);
            }
    ...
    function drawElement(element, strokeWidth, strokeStyle, fillStyle, selector) {
    ...
    function applyStyles() {
        ...
        $.each(settings.styles, function (idx, style) {
            find(style.selector).each(function () {
                drawElement(this, style.strokeWidth, style.strokeStyle, style.fillStyle, style.selector);
            });
        });
    }
    ...
    function draw() {
        ...
        currentScale = $canvas.height() / currentContentRect.height;
